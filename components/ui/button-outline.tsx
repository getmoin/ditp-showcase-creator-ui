...
const ButtonOutline: React.FC<ButtonProps> = ({
	...
	return (
		<button
			className={`border-2 border-dark-border dark:border-none uppercase dark:bg-dark-btn text-light-text dark:text-dark-text hover:bg-gray-100 dark:hover:bg-dark-btn-hover
