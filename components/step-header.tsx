...
// import { Delete, Download, EllipsisVertical, Eye, RotateCcw, RotateCw, Trash, Trash2 } from "lucide-react";
...
// const StepHeader: React.FC<StepHeaderProps> = ({ icon, title, actions, showDropdown = true }) => {
...
//               <li className="flex gap-2 px-4 py-2 hover:bg-light-bg-secondary dark:hover:bg-dark-input-hover cursor-pointer">
//                 <Download size={20}/>
//                 Save Draft
//               </li>
//               <li className="flex gap-2 px-4 py-2 hover:bg-light-bg-secondary dark:hover:bg-dark-input-hover cursor-pointer">
...
//                 Preview
//               </li>
//               <li className="flex gap-2 px-4 py-2 hover:bg-light-bg-secondary dark:hover:bg-dark-input-hover cursor-pointer border-b border-light-border-secondary dark:border-dark-border px-2">
//               <RotateCw size={20} />
//                 Revert Changes
//               </li>
//               <li className="flex gap-2 px-4 mt-2 py-2 hover:bg-light-bg-secondary dark:hover:bg-dark-input-hover cursor-pointer">
//               <Trash2 size={20} />
//                 Delete Page
//               </li>
//             </ul>
